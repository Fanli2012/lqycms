...
insert  into `fl_tagindex`(`id`,`tag`,`title`,`description`,`content`,`pubdate`,`keywords`,`click`,`litpic`,`template`,`filename`) values (1,'百度金融','百度金融title','百度金融description','百度金融content',1472636530,'百度金融keywords',250,'/uploads/2016/08/201608310852454298.png','tag','bdjr'),(2,'李彦宏','李彦宏title','李彦宏description','<p>李彦宏content</p>',1484910609,'李彦宏keywords',361,'','tag','leo');
...
insert  into `fl_taglist`(`tid`,`aid`) values (1,5),(1,13),(2,10),(2,12);
