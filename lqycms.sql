...
insert  into `fl_friendlink`(`id`,`webname`,`url`,`group_id`) values (1,'72PCMS2','http://www.1104.org/',0),(2,'炒股入门知识','http://www.pe7.org/',0);
...
insert  into `fl_product_type`(`id`,`reid`,`addtime`,`typename`,`seotitle`,`keywords`,`description`,`content`,`sortrank`,`typedir`,`templist`,`temparticle`,`litpic`,`seokeyword`,`status`) values (1,0,1476063788,'海鲜','新闻中心_72pcms','新闻中心','新闻中心','<p>新闻中心</p>',50,'news','category','detail','/uploads/2016/10/201610100341073966.jpg','新闻中心',1),(2,0,1476063429,'零食','企业新闻_72pcms','企业新闻','企业新闻','<p>企业新闻</p>',50,'qiye','category','detail','','企业新闻',1),(3,1,1476063419,'水果','行业新闻_72pcms','行业新闻','行业新闻','<p>行业新闻</p>',50,'hangye','category','detail','','行业新闻',1),(4,1,1476068069,'咖啡','','','','<p>案例中心内容</p>',50,'case','category','detail','','',1),(6,1,1484914393,'qw','qw','qw','qw','<p>qw</p>',50,'qw','productcategory.html','productdetail.html','','qw',1),(7,0,1496295393,'sadf','sadf','sadf','sadf','<p>sdfsaf</p>',50,'safd','productcategory','productdetail','/uploads/2017/05/201705311643481302.png','sadf',1),(8,7,1496295741,'sadfsa2','adf2','sdf2','11df2','<p>sdafasfd211</p>',50,'df2','productcategory','productdetail','/uploads/2017/05/201705311643481302.png','s2',1);
